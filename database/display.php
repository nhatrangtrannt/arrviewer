...
-->
    <?php
            ...
            //echo "<model-viewer ar ar-modes='webxr scene-viewer quick-look' camera-controls src='data:application/octet-stream;base64,".base64_encode($row['imageData'])."' alt='A 2 chair'>
            //        <button slot='ar-button' id='ar-button'>
            //        View in your space
            //        </button>
            //    ";
